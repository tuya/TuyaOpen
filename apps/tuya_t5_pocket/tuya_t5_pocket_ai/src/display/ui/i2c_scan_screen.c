...
static void create_scan_matrix(void)
{
    ...
    lv_obj_set_size(dev_list, SCREEN_WIDTH - 20, SCREEN_HEIGHT - 50);
    ...
    lv_obj_set_size(content_container, LV_PCT(100), SCREEN_HEIGHT - 100);
...
#else
                // Simulator mode - show some dummy data
...
void i2c_scan_screen_init(void)
{
    ...
    lv_obj_set_size(ui_i2c_scan_screen, SCREEN_WIDTH, SCREEN_HEIGHT);
