...
#define TUYA_OPENSDK_UUID      "uuidd4ccf1ec05f18df8"                    // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY   "oBV3ALZVIMAUxlDiTbpVsrxvAE84eutz"        // Please change the correct authkey
