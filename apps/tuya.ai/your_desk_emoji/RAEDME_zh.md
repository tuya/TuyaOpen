...
# your_desk_emoji
 [your_desk_emoji](https://github.com/tuya/TuyaOpen/tree/master/apps/tuya.ai/your_desk_emoji) 是基于 tuya.ai 的智能桌面表情机器人。结合AI对话、手势识别、舵机控制和表情显示，打造一个互动的桌面伙伴。
...
4. 基于PAJ7620传感器的手势识别
5. 舵机电机控制，实现互动动作
6. 支持 LCD 显示实时聊天内容、支持 APP 端实时查看聊天内容
7. 蓝牙配网快捷连接路由器
8. APP 端实时切换 AI 智能体角色
