...
typedef enum {
    ...
    AI_AUDIO_ALERT_BI_TONE,
    AI_AUDIO_CANCEL_FAIL_TRI_TONE,
    AI_AUDIO_CONFIRM,
    AI_AUDIO_DOWNWARD_BI_TONE,
    AI_AUDIO_FAIL_CANCEL_BI_TONE,
    AI_AUDIO_LOADING_TONE,
    AI_AUDIO_SHORT_SELECT_TONE,
    AI_AUDIO_THREE_STAGE_UP_TONE,
