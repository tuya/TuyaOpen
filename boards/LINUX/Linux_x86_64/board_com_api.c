 ...
 * @author Tuya Inc.
 * @brief Implementation of common board-level hardware registration APIs for Linux x86_64 platform.
 *
 * This file provides the implementation for initializing and registering hardware
 * components on the Linux x86_64 platform, with primary focus on ALSA audio support.
 *
...
/**
 * @brief Registers ALSA audio device for Linux x86_64 platform
 *
 ...
 * On x86_64, "default" routes to PulseAudio/WirePlumber.
 *
...
/**
 * @brief Registers button hardware for Linux x86_64 platform
 *
 * On Linux x86_64, we use keyboard input instead of physical buttons.
...
/**
 * @brief Registers LED hardware for Linux x86_64 platform
 *
 * Note: LED support on x86_64 is not applicable (no GPIO).
...
/**
 * @brief Registers V4L2 USB camera for Linux x86_64 platform
 */
...
OPERATE_RET board_register_hardware(void)
{
    ...
    PR_INFO("Registering Linux x86_64 platform hardware...");
    ...
    PR_INFO("Linux x86_64 platform hardware registration completed");
