/**
 * @file sparkleiot_t5ai_dev.c
 * @brief SPARKLEIOT_T5AI_DEV board: T5 pin breakout (optional I2S audio add-on)
 * @version 0.2
 * @date 2026-08-18
...
#if defined(SPARKLEIOT_T5AI_DEV_I2S_AUDIO) && (SPARKLEIOT_T5AI_DEV_I2S_AUDIO == 1)
...
static OPERATE_RET __board_register_audio(void)
{
    ...
    PR_NOTICE("SPARKLEIOT_T5AI_DEV: I2S duplex registered (mic P42 + spk P43, clk P40/P41)");
#endif
#else
    PR_NOTICE("SPARKLEIOT_T5AI_DEV: I2S audio add-on disabled");
#endif
...
static OPERATE_RET __board_register_button(void)
{
    ...
    PR_NOTICE("SPARKLEIOT_T5AI_DEV: button on P%d registered", BOARD_BUTTON_PIN);
#endif
