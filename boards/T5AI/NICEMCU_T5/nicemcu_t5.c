/**
 * @file nicemcu_t5.c
 * @brief NiceMCU-T5 board: T5 pin breakout with INMP441 + MAX98357
 * @version 0.1
 * @date 2026-08-12
 ...
 * --------------------------------------------------------------------------- */
/**
 * @brief Register INMP441 mic + MAX98357 amp over dual I2S
...
static OPERATE_RET __board_register_audio(void)
{
    ...
    PR_NOTICE("NICEMCU_T5: I2S duplex registered (mic P42 + spk P43, clk P40/P41)");
#endif
...
static OPERATE_RET __board_register_button(void)
{
    ...
    PR_NOTICE("NICEMCU_T5: button on P%d registered", BOARD_BUTTON_PIN);
#endif
