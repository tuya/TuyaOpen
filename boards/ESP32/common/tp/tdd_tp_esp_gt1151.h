 ...
 * esp_lcd_touch_new_i2c_gt1151(), and registers the resulting handle with the
 ...
 * APIs.
 *
 * The GT1151 read path is 2 I2C transactions with a checksum, so it stays clean
 * on an I2C bus shared with a continuously-refreshing RGB panel; the GT911
 * driver's longer, checksum-less read NACKs under that contention.
 *
 * @copyright Copyright (c) 2021-2025 Tuya Inc. All Rights Reserved.
 */

#ifndef __TDD_TP_ESP_GT1151_H__
#define __TDD_TP_ESP_GT1151_H__
