/**
 * @file xteink_x4_pro_sdcard.h
 * @brief microSD helpers for Xteink X4 Pro (native SDMMC).
 * @version 0.1
 * @date 2026-08-18
 * @copyright Copyright (c) 2026 Tuya Inc. All Rights Reserved.
 */
#ifndef __XTEINK_X4_PRO_SDCARD_H__
#define __XTEINK_X4_PRO_SDCARD_H__
...
#define X4PRO_SDCARD_MOUNT_PATH "/sdcard"

typedef OPERATE_RET (*X4PRO_SDCARD_LIST_CB)(const char *path, bool is_dir, void *user_data);
...
#endif
#endif /* __XTEINK_X4_PRO_SDCARD_H__ */
