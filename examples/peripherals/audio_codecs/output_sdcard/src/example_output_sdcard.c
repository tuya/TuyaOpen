...
/* Keep names within FAT 8.3 (ESP-IDF FATFS defaults to LFN-none, so long
 * names like "tuya_recorder.wav" fail to open on ESP32). */
#define EXAMPLE_RECORDER_FILE_PATH     "/sdcard/record.pcm"
#define EXAMPLE_RECORDER_WAV_FILE_PATH "/sdcard/record.wav"
