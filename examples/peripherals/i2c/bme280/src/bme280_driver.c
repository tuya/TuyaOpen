...
#elif (BME280_I2C_BUS == 2)
  #define _I2C_BUS_ID TUYA_I2C_NUM_2
  #define _PINMUX_SCL_FUNC TUYA_IIC2_SCL
  #define _PINMUX_SDA_FUNC TUYA_IIC2_SDA
#elif (BME280_I2C_BUS == 3)
  #define _I2C_BUS_ID TUYA_I2C_NUM_3
  #define _PINMUX_SCL_FUNC TUYA_IIC3_SCL
  #define _PINMUX_SDA_FUNC TUYA_IIC3_SDA
#elif (BME280_I2C_BUS == 4)
  #define _I2C_BUS_ID TUYA_I2C_NUM_4
  #define _PINMUX_SCL_FUNC TUYA_IIC4_SCL
  #define _PINMUX_SDA_FUNC TUYA_IIC4_SDA
#elif (BME280_I2C_BUS == 5)
  #define _I2C_BUS_ID TUYA_I2C_NUM_5
  #define _PINMUX_SCL_FUNC TUYA_IIC5_SCL
  #define _PINMUX_SDA_FUNC TUYA_IIC5_SDA
#else
