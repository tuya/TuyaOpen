...
| `TUYA_PWM_NUM_2` | LEDC 通道 2 | `TUYA_PWM2` | GPIO3 | 可经 Pinmux 重映射。 |
| `TUYA_PWM_NUM_3` | LEDC 通道 3 | `TUYA_PWM3` | GPIO4 | 可经 Pinmux 重映射。 |
| `TUYA_PWM_NUM_4` | LEDC 通道 4 | `TUYA_PWM4` | GPIO5 | 可经 Pinmux 重映射。 |
| `TUYA_PWM_NUM_5` | LEDC 通道 5 | `TUYA_PWM5` | GPIO6 | 可经 Pinmux 重映射。 |
...
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 0` | ADC2_CH0 | GPIO5 | 需启用 `CONFIG_ADC_ONESHOT_FORCE_USE_ADC2_ON_C3`。 |
