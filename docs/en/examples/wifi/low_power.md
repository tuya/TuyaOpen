...
title WIFI LOW POWER
start

#pink:入口函数: tuya_app_main;
#palegreen:wifi 低功耗初始化: tal_cpu_set_lp_mode;
#palegreen:设置 dtim: tal_set_wifi_lp_dtim;
#palegreen:退出 wifi 低功耗: tal_wifi_lp_disenable;
#palegreen:退出功耗之后相关任务处理;
#palegreen:使能 wifi 低功耗: tal_wifi_lp_enable;
#pink:结束;
end
@enduml
```
