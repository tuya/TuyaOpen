...
| --- | --- | --- |
| `TUYA_GPIO_NUM_0`–`TUYA_GPIO_NUM_7` | GPIO0–GPIO7 | 普通 GPIO，RTCIO |
| `TUYA_GPIO_NUM_8`–`TUYA_GPIO_NUM_28` | GPIO8–GPIO28 | 普通 GPIO |
| `TUYA_GPIO_NUM_29` | GPIO29 | 不可用 |
| `TUYA_GPIO_NUM_30`–`TUYA_GPIO_NUM_40` | GPIO30–GPIO40 | 普通 GPIO |
| `TUYA_GPIO_NUM_41` | GPIO41 | 不可用 |
| `TUYA_GPIO_NUM_42`–`TUYA_GPIO_NUM_49` | GPIO42–GPIO49 | 普通 GPIO，ADC1_CH0–CH7 |
| `TUYA_GPIO_NUM_50`–`TUYA_GPIO_NUM_57` | GPIO50–GPIO57 | 普通 GPIO，ADC2_CH0–CH7 |
| `TUYA_GPIO_NUM_58`–`TUYA_GPIO_NUM_61` | GPIO58–GPIO61 | 普通 GPIO |
...
| `TUYA_UART_NUM_1` | UART1 | `TUYA_UART1_TX` | GPIO17 | 可经 Pinmux 重映射。 |
| `TUYA_UART_NUM_1` | UART1 | `TUYA_UART1_RX` | GPIO18 | 可经 Pinmux 重映射。 |
...
| --- | --- | --- | --- | --- | --- |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 0` | ADC1_CH0 | GPIO42 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 1` | ADC1_CH1 | GPIO43 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 2` | ADC1_CH2 | GPIO44 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 3` | ADC1_CH3 | GPIO45 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 4` | ADC1_CH4 | GPIO46 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 5` | ADC1_CH5 | GPIO47 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 6` | ADC1_CH6 | GPIO48 |  |
| `TUYA_ADC_NUM_0` | ADC1 | `ch_id = 7` | ADC1_CH7 | GPIO49 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 0` | ADC2_CH0 | GPIO50 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 1` | ADC2_CH1 | GPIO51 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 2` | ADC2_CH2 | GPIO52 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 3` | ADC2_CH3 | GPIO53 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 4` | ADC2_CH4 | GPIO54 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 5` | ADC2_CH5 | GPIO55 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 6` | ADC2_CH6 | GPIO56 |  |
| `TUYA_ADC_NUM_1` | ADC2 | `ch_id = 7` | ADC2_CH7 | GPIO57 |  |
...
| TKL 端口 | 芯片数据手册端口 | TKL 标识 | 芯片数据手册 GPIO | 说明 |
| --- | --- | --- | --- | --- |
| `TUYA_I2S_NUM_0` | I2S0 | `TUYA_I2S0_SCK` | GPIO3 | 驱动固定引脚。 |
| `TUYA_I2S_NUM_0` | I2S0 | `TUYA_I2S0_WS` | GPIO4 | 驱动固定引脚。 |
| `TUYA_I2S_NUM_0` | I2S0 | `TUYA_I2S0_SDO_0` | GPIO5 | 驱动固定引脚。 |
| `TUYA_I2S_NUM_0` | I2S0 | `TUYA_I2S0_SDI_0` | GPIO5 | 与 SDO 共用 GPIO5。 |
