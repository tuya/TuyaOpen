                                 ...
                                 char *payload)
{
    ...
    if (type == AI_PT_VIDEO) {
        ...
        char *video = tal_malloc(payload_len);
        ...
        char *audio = tal_malloc(payload_len);
        ...
        char *image = tal_malloc(payload_len);
        ...
        char *file = tal_malloc(payload_len);
        ...
        char *text = tal_malloc(payload_len);
...
static OPERATE_RET __ai_clt_run_evt(void *data)
{
    ...
    if (NULL == ai_basic_biz) {
        ai_basic_biz = (AI_BASIC_BIZ_T *)tal_malloc(sizeof(AI_BASIC_BIZ_T));
