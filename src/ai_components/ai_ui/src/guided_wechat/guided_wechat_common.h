/**
 * @file guided_wechat_common.h
 * @brief Internal header shared among wechat UI page files.
 * @copyright Copyright (c) 2021-2026 Tuya Inc. All Rights Reserved.
 */

#ifndef __GUIDED_WECHAT_COMMON_H__
#define __GUIDED_WECHAT_COMMON_H__
 ...
 * --------------------------------------------------------------------------- */
#if defined(GUIDED_WECHAT_SCREEN_CORNER_RADIUS) && (GUIDED_WECHAT_SCREEN_CORNER_RADIUS > 0)
#define WECHAT_ROUNDED_CORNER_RADIUS   GUIDED_WECHAT_SCREEN_CORNER_RADIUS
#else
 ...
 * Max clip depth at 45掳 = R*(1-cos45掳) 鈮?R*0.293, so R/2 is conservative.
 */
...
#endif /* __GUIDED_WECHAT_COMMON_H__ */
