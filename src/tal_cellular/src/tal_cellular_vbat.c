...
{
    if(tkl_cellular_vbat_desc_get()->get_rsoc == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->get_rsoc(rsoc);
}
...
{
    if(tkl_cellular_vbat_desc_get()->ntc_enable == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->ntc_enable(enable);
}
...
{
    if(tkl_cellular_vbat_desc_get()->set_charge_current == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->set_charge_current(current);
}
...
{
    if(tkl_cellular_vbat_desc_get()->get_charger_state == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->get_charger_state();
}
...
{
    if(tkl_cellular_vbat_desc_get()->charge_cb_register == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->charge_cb_register(callback);
}
...
{
    if(tkl_cellular_vbat_desc_get()->get_voltage == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->get_voltage(voltage);
}
...
{
    if(tkl_cellular_vbat_desc_get()->low_volt_poweroff_enable == NULL) {
        return OPRT_NOT_SUPPORTED;
    }
    return tkl_cellular_vbat_desc_get()->low_volt_poweroff_enable(enable);
}