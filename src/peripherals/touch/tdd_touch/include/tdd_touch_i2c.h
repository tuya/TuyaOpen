 ...
 * @brief I2C communication interface definitions for touch controllers
 *
 * This header file defines the I2C communication interface structures and
 * function prototypes for touch controller devices in the TDD layer. It provides
 * configuration structures for I2C parameters and common I2C read/write functions
 * used by various touch controller drivers.
 *
