...
OPERATE_RET tdl_axp2101_write_reg(axp2101_dev_t *dev, uint8_t reg, uint8_t data)
{
    OPERATE_RET ret;
    uint8_t buf[2];
...
OPERATE_RET tdl_axp2101_read_regs(axp2101_dev_t *dev, uint8_t reg, uint8_t *data, uint8_t len)
{
    OPERATE_RET ret;
...
{
    uint8_t data;
    if (tdl_axp2101_read_regs(&axp2101_dev, reg, &data, 1) == OPRT_OK) {
        return data;
    }
    return 0;
}
...
{
    return tdl_axp2101_write_reg(&axp2101_dev, reg, data) == OPRT_OK;
}
...
{
    uint8_t value;
    if (tdl_axp2101_read_regs(&axp2101_dev, reg, &value, 1) != OPRT_OK) {
        return false;
    }
...
bool setRegisterBit(uint8_t reg, uint8_t bit)
{
    ...
    value |= (1U << bit);
    return (tdl_axp2101_write_reg(&axp2101_dev, reg, value) == OPRT_OK);
}
...
// getBatPresentState
bool tdl_axp2101_isBatteryConnect(void)
{
...
bool tdl_axp2101_isCharging(void)
{
    return (readRegister(XPOWERS_AXP2101_STATUS2) >> 5) == 0x01;
}

bool tdl_axp2101_isDischarge(void)
{
...
bool tdl_axp2101_isVbusIn(void)
{
 ...
 * @retval None
 */
void tdl_axp2101_shutdown(void)
{
 ...
 */
void tdl_axp2101_setVbusVoltageLimit(uint8_t opt)
{
 ...
 *              parameters in "XPowersParams.hpp"
 */
uint8_t tdl_axp2101_getVbusVoltageLimit(void)
{
 ...
 */
bool tdl_axp2101_setVbusCurrentLimit(xpower_apx2101_vbus_vol_limit_t opt)
{
 ...
 *              parameters in "XPowersParams.hpp"
 */
uint8_t tdl_axp2101_getVbusCurrentLimit(void)
{
 ...
 */
void tdl_axp2101_enableCellbatteryCharge(void)
{
...
void enableWatchdog(void)
{
    ...
    tdl_axp2101_enableIRQ(XPOWERS_AXP2101_WDT_EXPIRE_IRQ);
}

void disableWatchdog(void)
{
    tdl_axp2101_disableIRQ(XPOWERS_AXP2101_WDT_EXPIRE_IRQ);
...
bool tdl_axp2101_setSysPowerDownVoltage(uint16_t millivolt)
{
...
uint16_t tdl_axp2101_getSysPowerDownVoltage(void)
{
    int val = readRegister(XPOWERS_AXP2101_VOFF_SET);
    if (val == -1)
        return false;
...
bool tdl_axp2101_enableSleep(void)
{
 ...
 * @retval
 */
bool tdl_axp2101_setPowerKeyPressOnTime(uint8_t opt)
{
    int val = readRegister(XPOWERS_AXP2101_IRQ_OFF_ON_LEVEL_CTRL);
    if (val == -1)
        return false;
 ...
 */
uint8_t tdl_axp2101_getPowerKeyPressOnTime(void)
{
    int val = readRegister(XPOWERS_AXP2101_IRQ_OFF_ON_LEVEL_CTRL);
    if (val == -1)
        return 0;
 ...
 * @retval
 */
bool tdl_axp2101_setPowerKeyPressOffTime(uint8_t opt)
{
    int val = readRegister(XPOWERS_AXP2101_IRQ_OFF_ON_LEVEL_CTRL);
    if (val == -1)
        return false;
 ...
 */
uint8_t tdl_axp2101_getPowerKeyPressOffTime(void)
{
...
bool tdl_axp2101_enableTemperatureMeasure(void)
{
    return setRegisterBit(XPOWERS_AXP2101_ADC_CHANNEL_CTRL, 4);
}

bool tdl_axp2101_disableTemperatureMeasure(void)
{
...
bool tdl_axp2101_disableTSPinMeasure(void)
{
 ...
 */
void tdl_axp2101_setChargingLedMode(uint8_t mode)
{
    int val;
    switch (mode) {
 ...
 * @retval None
 */
void tdl_axp2101_setPrechargeCurr(xpowers_prechg_t opt)
{
 ...
 * @retval
 */
bool tdl_axp2101_setChargerConstantCurr(xpowers_axp2101_chg_curr_t opt)
{
 ...
 */
uint8_t tdl_axp2101_getChargerConstantCurr(void)
{
    int val = readRegister(XPOWERS_AXP2101_ICC_CHG_SET);
    if (val == -1)
        return 0;
 ...
 * @retval
 */
bool tdl_axp2101_setChargeTargetVoltage(xpowers_axp2101_chg_vol_t opt)
{
 ...
 */
uint8_t tdl_axp2101_getChargeTargetVoltage(void)
{
 ...
 */
uint64_t tdl_axp2101_getIrqStatus(void)
{
 ...
 */
void tdl_axp2101_clearIrqStatus()
{
...
// IRQ STATUS 1
bool tdl_axp2101_isVbusInsertIrq(void)
{
...
bool tdl_axp2101_isVbusRemoveIrq(void)
{
...
bool tdl_axp2101_isBatInsertIrq(void)
{
...
bool tdl_axp2101_isBatRemoveIrq(void)
{
...
bool tdl_axp2101_isPekeyShortPressIrq(void)
{
...
bool tdl_axp2101_isPekeyLongPressIrq(void)
{
...
bool tdl_axp2101_isBatChargeDoneIrq(void)
{
...
bool tdl_axp2101_isBatChargeStartIrq(void)
{
...
uint8_t tdl_axp2101_getChipID(void)
{
    return readRegister(XPOWERS_AXP2101_IC_TYPE);
}

uint16_t tdl_axp2101_getPowerChannelVoltage(XPowersPowerChannel_t channel)
{
    switch (channel) {
    case XPOWERS_DCDC1:
...
bool tdl_axp2101_enablePowerOutput(XPowersPowerChannel_t channel)
{
    switch (channel) {
    case XPOWERS_DCDC1:
        return enableDC1();
...
bool tdl_axp2101_disablePowerOutput(XPowersPowerChannel_t channel)
{
...
bool tdl_axp2101_isPowerChannelEnable(XPowersPowerChannel_t channel)
{
    switch (channel) {
    case XPOWERS_DCDC1:
        return isEnableDC1();
...
bool tdl_axp2101_setPowerChannelVoltage(XPowersPowerChannel_t channel, uint16_t millivolt)
{
    // if (getProtectedChannel(channel)) {
 ...
 * @retval
 */
bool tdl_axp2101_enableIRQ(uint64_t opt)
{
 ...
 * @retval
 */
bool tdl_axp2101_disableIRQ(uint64_t opt)
{
...
bool tdl_axp2101_isChannelAvailable(uint8_t channel)
{
    switch (channel) {
    case XPOWERS_DCDC1:
    case XPOWERS_DCDC2:
...
void tdl_axp2101_setProtectedChannel(uint8_t channel)
{
    __protectedMask |= _BV(channel);
}

void tdl_axp2101_setUnprotectChannel(uint8_t channel)
{
    __protectedMask &= (~_BV(channel));
}

bool tdl_axp2101_getProtectedChannel(uint8_t channel)
{
...
bool tdl_axp2101_enableInterrupt(uint32_t option)
{
    return tdl_axp2101_setInterruptMask(option, true);
}

bool tdl_axp2101_disableInterrupt(uint32_t option)
{
    return tdl_axp2101_setInterruptMask(option, false);
}

bool tdl_axp2101_setInterruptMask(uint32_t option, bool enable)
{
    uint64_t params = 0;
    ...
    return enable ? tdl_axp2101_enableIRQ(params) : tdl_axp2101_disableIRQ(params);
}

OPERATE_RET tdl_axp2101_init(void)
{
    OPERATE_RET rt = OPRT_OK;

    TUYA_CALL_ERR_RETURN(__i2c_init());

    if (XPOWERS_AXP2101_CHIP_ID == tdl_axp2101_getChipID()) {
        PR_DEBUG("AXP2101 detected");
    } else {
        PR_ERR("AXP2101 not detected, chip id is 0x%02X, expect 0x%02X", tdl_axp2101_getChipID(),
...
OPERATE_RET tdl_axp2101_deinit(void)
{
    OPERATE_RET rt = OPRT_OK;
...
void tdl_axp2101_print_pwr_info(void)
{
    PR_NOTICE("======================================DCDC=================================");
...
void tdl_axp2101_print_chg_info(void)
{
    PR_DEBUG("isCharging: %s", tdl_axp2101_isCharging() ? "YES" : "NO");
    PR_DEBUG("isDischarge: %s", tdl_axp2101_isDischarge() ? "YES" : "NO");
    PR_DEBUG("isStandby: %s", isStandby() ? "YES" : "NO");
    PR_DEBUG("isVbusIn: %s", tdl_axp2101_isVbusIn() ? "YES" : "NO");
    ...
    PR_DEBUG("getBattVoltage: %d mV", tdl_axp2101_getBattVoltage());
    PR_DEBUG("getVbusVoltage: %d mV", tdl_axp2101_getVbusVoltage());
    PR_DEBUG("getSystemVoltage: %d mV", tdl_axp2101_getSystemVoltage());

    // The battery percentage may be inaccurate at first use, the PMU will automatically
    // learn the battery curve and will automatically calibrate the battery percentage
    // after a charge and discharge cycle
    if (tdl_axp2101_isBatteryConnect()) {
        PR_DEBUG("getBatteryPercent: %d %% ", tdl_axp2101_getBatteryPercent());
    }
}
