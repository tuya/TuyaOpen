...
#ifndef __TDL_AXP2101_DRIVER_H__
#define __TDL_AXP2101_DRIVER_H__
...
uint16_t tdl_axp2101_status(void);
...
void tdl_axp2101_clearIrqStatus(void);
bool tdl_axp2101_enableIRQ(uint64_t opt);
bool tdl_axp2101_disableIRQ(uint64_t opt);
bool tdl_axp2101_enableInterrupt(uint32_t opt);
bool tdl_axp2101_disableInterrupt(uint32_t opt);
