 ...
 * @brief Header file for the display management module.
 *
 * This file contains the definitions and function declarations used for managing 
 * display devices, including frame buffer handling, device information retrieval, 
 * and basic display operations such as open, close, flush, and brightness control.
 *
