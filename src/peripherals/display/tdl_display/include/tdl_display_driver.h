 ...
 * @brief Header file for the display driver framework.
 *
 * This file defines the core data structures, function prototypes, and interface 
 * required for registering and managing different types of display devices (SPI, QSPI, 
 * MCU8080, RGB, etc.). It provides abstraction for display initialization, control, 
 * and frame buffer flushing operations.
 *
