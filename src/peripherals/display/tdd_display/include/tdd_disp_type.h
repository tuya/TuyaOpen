 ...
 * @brief Header file defining common display device configuration types and structures.
 *
 * This file contains the type definitions used across different display interface modules,
 * including configurations for software SPI, hardware SPI, QSPI, MCU8080, and I2C OLED interfaces.
 *
